const reviewsData = [
    {
        ...
        review_content: {
            ...
            en: `I want to leave a review too. We had one trial session with Sasha, and we are very satisfied! Our 3-year-old daughter immediately got used to her, and they formed a very good tandem. They get along well with children, even with such little ones like mine. It's still inconvenient for us to attend regularly because our daughter takes daytime naps, and I physically can't pick her up and get to the center after her nap. We're looking forward to when we stop napping during the day and can start with pleasure again.`,
        },
        hashtag: {
    ...
    },
    {
        ...
        review_content: {
            ru: 'Я тоже хочу оставить отзыв, у нас было одно пробное занятие с Сашей. Очень довольны! Дочка 3х лет сразу привыкла к ней, получился очень хороший тандем. С детьми ладят хорошо, даже с такими малышами как моя. Нам пока неудобно ходить так как у нас ещё есть дневной сон и я просто физически не успеваю её собрать и доехать до центра после сна. Ждём когда перестанем спать днем и снова начнём с удовольствием.',
            en: `Sasha is a wonderful coach! Highly recommended`,
        },
        hashtag: {
    ...
    },
    {
        ...
        review_content: {
            ...
            en: `I want to leave a review: my son is coached by Anna and he loves the lessons and looks forward to them!`,
        },
        hashtag: {
            ru: 'Групповое занятие плаванием в The Brentford Leisure Centre',
            en: 'Group swimming lesson at The Brentford Leisure Centre',
    ...
    },
    {
        ...
        name: {
            ru: 'Наталья Скалярова ',
            en: 'Natalia Skalyarova',
        },
        review_content: {
            ...
            en: `Great lessons! Our child now shows off tricks every day during the holidays, and how they swim is simply amazing. Thanks to Sasha and Anna!`,
        },
        hashtag: {
    ...
    },
    {
        ...
        review_content: {
            ...
            en: `I am truly satisfied with synchronised swimming lessons that my ten-year-old daughter attends. The instructor communicates excellently with children and makes learning exciting. My daughter adores these lessons; she eagerly anticipates them, and it's so delightful to see how she improves her swimming and enjoys diving and somersaulting underwater. Highly recommended! Safety Guarantees: We have first aid skills and have completed lifeguard training courses. The maximum depth of the pool is 1.2 metres. For the child's safety, the coach is in the water. All training sessions are tailored to the individual abilities of each child.`,
        },
        hashtag: {
            ru: 'Групповое занятие синхронным плаванием в The Brentford Leisure Centre ',
            en: 'Group synchronise swimming lesson at The Brentford Leisure Centre',
